...
export default function Navbar() {
  return (
    <nav className="fixed top-0 right-0 w-full flex justify-between items-center px-8 py-6 z-50 bg-black/50 backdrop-blur-md border-b border-gray-900/50">
      ...
      <div className="flex gap-8 text-sm">
        ...
        <Link href="/writing" className="text-gray-400 hover:text-gray-200 transition-colors duration-300">Writing</Link>
